...
function Death.draw()
    ...
    Fonts.print("DEFEATED", win_w / 2 - 50, 200)

    love.graphics.setColor(0.7, 0.7, 0.7)
    Fonts.print("Your cards have fallen...", win_w / 2 - 90, 280)
    ...
    Fonts.print(">> RETRY <<", btn_x + 50, btn_y + 10)
    ...
    Fonts.print("[ESC] Menu", btn_x + 60, menu_btn_y + 10)

    -- 操作提示
    love.graphics.setColor(0.5, 0.5, 0.5)
    Fonts.print("SPACE: Retry  |  ESC: Return to Menu", win_w / 2 - 100, 480)
end
